...
#### NOTICE: INSTALLING ENVELOPE SERVER ON WINDOWS IS EXPLAINED IN THE DOCUMENT: INSTALL_WIN.md
...
If you don't have your original build directory check the following locations:
    ...
    rm -r /usr/local/etc/envelope        # you may wish to save your config files first
