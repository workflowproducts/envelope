...
>
    <template for="top-hud">
        <gs-button
            onclick="tblElemByID('${1:tableid}').deleteSelected()"
            inline
            no-focus
            icononly
            icon="times"
        >&nbsp;</gs-button>
        <gs-button
            onclick="tblElemByID('${1:tableid}').openInsertDialog()"
            inline
            no-focus
            icononly
            icon="plus"
        >&nbsp;</gs-button>
        <gs-button
            onclick="tblElemByID('${1:tableid}').refresh()"
            inline
            no-focus
            icononly
            icon="refresh"
        >&nbsp;</gs-button>
        <gs-button
            onclick="tblElemByID('${1:tableid}').openPrefs(this)"
            inline
            no-focus
            icononly
            icon="sliders"
        >&nbsp;</gs-button>
        <gs-button
            onclick="tblElemByID('${1:tableid}').toFullscreen(this)"
            inline
            no-focus
            icononly
            icon="expand"
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <gs-button
            onclick="tblElemByID('${1:tableid}').sort('asc')"
            inline
            no-focus
            iconleft
            icon="sort-alpha-asc"
        ...
        <gs-button
            onclick="tblElemByID('${1:tableid}').sort('desc')"
            inline
            no-focus
            iconleft
        ...
        <gs-button
            onclick="tblElemByID('${1:tableid}').sort('clear')"
            inline
            no-focus
            iconleft
            icon="trash"
        ...
        <gs-button
            onclick="tblElemByID('${1:tableid}').clearFilter()"
            inline
            no-focus
            iconleft
            icon="trash"
    ...
    <template for="bottom-hud">
        <gs-button
            onclick="tblElemByID('${1:tableid}').goToLine('first')"
            inline
            no-focus
            icononly
            icon="step-backward"
        >&nbsp;</gs-button>
        <gs-button
          onclick="tblElemByID('${1:tableid}').goToLine('previous')"
            inline
            no-focus
            icononly
            icon="caret-left"
        ...
        <gs-button
            onclick="tblElemByID('${1:tableid}').goToLine('next')"
            inline
            no-focus
            icononly
            icon="caret-right"
        >&nbsp;</gs-button>
        <gs-button
            onclick="tblElemByID('${1:tableid}').goToLine('last')"
            inline
            no-focus
            icononly
            icon="step-forward"
        >&nbsp;</gs-button>
        <gs-button
            onclick="tblElemByID('${1:tableid}').goToLine('insert')"
            inline
            no-focus
            icononly
            icon="plus"
    ...
    window.designElementProperty_GSTABLE = function (selectedElement) {
        ...
        addProp(
            'No Column Reorder',
            true,
            '<gs-checkbox class="target" value="' + (selectedElement.hasAttribute('no-column-reorder')) + '" mini></gs-checkbox>',
            function () {
            this.removeAttribute('no-column-reorder');
            return setOrRemoveBooleanAttribute(
                selectedElement,
                'no-column-reorder',
                this.value === 'true',
        ...
        addProp(
            'No Contextmenu',
            true,
            '<gs-checkbox class="target" value="' + (selectedElement.hasAttribute('no-context-menu')) + '" mini></gs-checkbox>',
            function () {
        ...
        addProp(
            'No Column Dropdown',
            true,
            '<gs-checkbox class="target" value="' + (selectedElement.hasAttribute('no-column-dropdown')) + '" mini></gs-checkbox>',
            function () {
            this.removeAttribute('no-column-dropdown');
            return setOrRemoveBooleanAttribute(
                selectedElement,
                'no-insert-scroll',
                this.value === 'true',
        ...
        addProp(
            'Auto Column Widths',
            true,
            '<gs-checkbox class="target" value="' + (selectedElement.hasAttribute('column-auto-resize')) + '" mini></gs-checkbox>',
            function () {
            this.removeAttribute('column-auto-resize');
            return setOrRemoveBooleanAttribute(
                selectedElement,
                'column-auto-resize',
                this.value === 'true',
...
// ############################################################################
    ...
    var tblElemByID = document.getElementById;
    ...
    function siphonElement(element) {
        ...
        if (headerTemplate || dataTemplate || insertRWTemplate) {
            ...
            while (i < len) {
                ...
                // for automatic column widths, we need to know the ratios of
                //      the column widths. These ratios are in relation to each
                //      other. This way, when we resize all of the columns to
                //      fit the width of the viewport, we'll be able to keep
                //      them the same relative width. So, we need to calculate
                //      the total width of all the columns.
                intTotalWidth += element.internalDisplay.columnWidths[i];

                i += 1;
            }

            // in case of automatic resizing, calculate column ratios. These
            //      can only changed by manually re-sizing the columns.
            i = 0;
            len = arrColumnElements.length;
            while (i < len) {
                element.internalDisplay.columnRatios.push(
                    (
                        element.internalDisplay.columnWidths[i] /
                        intTotalWidth
                    ) * 100
        ...
        //      the column dropdown
        if (headerTemplate && !element.hasAttribute('no-column-dropdown')) {
    ...
    function bindCellResize(element) {
        ...
        element.internalEvents.columnAutoResize = function () {
            ...
            while (i < len) {
                ...
                if (i < (len - 1)) {
                    element.internalDisplay.columnWidths[i] -= 1;
                }
