...
// ############################################################################
    ...
    function renderSelection(element) {//<br />
        ...
        var cellInput;
        console.log(element.internalSelection);
        console.log(element.internalSelection.ranges[0]);
        //console.log(element.internalSelection.ranges[0].start);
        if (element.internalSelection && element.internalSelection.ranges[0]
            && element.internalSelection.ranges[0].start
        ) {
            if (element.internalSelection.ranges[0].start.row ===
                ...
                console.log();
                var strColumn = element.internalDisplay.columnPlainTextNames[
                    element.internalSelection.ranges[0].start.column
                ];
                var singleSelectedCell = xtag.queryChildren(element.elems.dataViewport
                , 'gs-cell[data-col-number="' + element.internalSelection.ranges[0].end.column + '"]' +
                '[data-row-number="' + element.internalSelection.ranges[0].end.row + '"]');
                cellInput = xtag.query(singleSelectedCell, 'input, textarea');
                if (cellInput) {
                    element.internalSelection.singleCell = {
                        'start': cellInput.selectionStart,
                        'end': cellInput.selectionEnd
                    };
                }
            }
        }
        ...
        if (cellInput) {
            cellInput.setInputSelection(element.internalSelection.singleCell.start, element.internalSelection.singleCell.end);
        }
